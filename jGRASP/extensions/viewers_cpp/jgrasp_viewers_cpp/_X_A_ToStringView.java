...
public class _X_A_ToStringView extends StringListViewWSV {
   ...
   public void getInfo(final ViewerInfo vi) {
      vi.setShortDescription("Array viewer");
      vi.setLongDescription("This viewer displays the array element values as a list. Selecting an element will "
            + "cause its value to be displayed in a subviewer.");
   }
