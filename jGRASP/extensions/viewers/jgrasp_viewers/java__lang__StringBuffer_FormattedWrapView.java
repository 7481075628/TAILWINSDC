...
public class java__lang__StringBuffer_FormattedWrapView extends TextAreaView {
   ...
   public java__lang__StringBuffer_FormattedWrapView(final ViewerCreateData vcd) {
      super(true);
   }
   ...
   public void getInfo(final ViewerInfo vi) {
      ...
      vi.setLongDescription("This viewer displays a the String value of a StringBuffer as it would be displayed in a "
            + "wrapped text window.");
   }
