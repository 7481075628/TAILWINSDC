...
public class java__lang__Byte_ByteView extends IntView {
   ...
   public String getDisplayText(final Value value, final DebugContext context) throws ViewerException {
      Method getValueMethod = value.getMethod(context, "byteValue", "byte", null);
      byte val = value.invokeMethod(context, getValueMethod, null).toByte(context);
   ...
   public void getInfo(final ViewerInfo vi) {
      ...
      vi.setLongDescription("This viewer displays a Byte's value in decimal, hex, octal, and binary forms.");
   }
}
