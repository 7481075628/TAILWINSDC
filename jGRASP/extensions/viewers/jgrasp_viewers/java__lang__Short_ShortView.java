...
public class java__lang__Short_ShortView extends IntView {
   ...
   public String getDisplayText(final Value value, final DebugContext context) throws ViewerException {
      Method getValueMethod = value.getMethod(context, "shortValue", "short", null);
      short val = value.invokeMethod(context, getValueMethod, null).toShort(context);
   
      int intVal = val & 0xFFFF;
      return "Decimal: " + val + "\nHex: 0x" + Integer.toHexString(intVal).toUpperCase(Locale.ENGLISH) + "\nOctal: 0"
   ...
   public void getInfo(final ViewerInfo vi) {
      ...
      vi.setLongDescription("This viewer displays a Short's value in decimal, hex, octal, and binary forms.");
   }
}
