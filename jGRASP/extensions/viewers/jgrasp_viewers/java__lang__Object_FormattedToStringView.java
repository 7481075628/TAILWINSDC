...
public class java__lang__Object_FormattedToStringView extends TextAreaView {
   ...
   public java__lang__Object_FormattedToStringView(final ViewerCreateData vcd) {
      /* *** Only show this viewer when the target value overrides Object.toString() and is not java.lang.String. */
      DebugContext dc = vcd.getDebugContext();
      Type t = vcd.getValue().getType(dc);
      Method toStringMethod;
      try {
         toStringMethod = t.getMethod(dc, "toString", "java.lang.String", null);
      }
      catch (Exception e) {
      ...
      if (dtName.equals("java.lang.Object") || dtName.equals("java.lang.String")) {
         throw new PluginOptOut();
      }
   }
   ...
   public void getInfo(final ViewerInfo vi) {
      ...
      vi.setLongDescription("This viewer displays the toString() value of an object as it would be displayed in a "
            + "text window.");
   }
