...
public class _X_BasicView extends TreeViewer {
   ...
   public void getInfo(final ViewerInfo vi) {
      ...
      vi.setLongDescription("This viewer displays a value as an expandable tree. See \"Java Debugging\" in the help "
            + "contents for an explanation of the colors and shapes used in the display.");
   }
