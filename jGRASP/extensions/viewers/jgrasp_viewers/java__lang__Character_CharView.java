...
public class java__lang__Character_CharView extends IntView {
   ...
   public String getDisplayText(final Value value, final DebugContext context) throws ViewerException {
      Method getValueMethod = value.getMethod(context, "charValue", "char", null);
      char val = value.invokeMethod(context, getValueMethod, null).toChar(context);
   ...
   public void getInfo(final ViewerInfo vi) {
      ...
      vi.setLongDescription("This viewer displays a Character's value as a char and the source format for the char, "
            + "and its numeric value in decimal, hex, octal, and binary forms.");
   }
}
