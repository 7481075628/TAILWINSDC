...
public class java__lang__Double_DoubleView extends FloatView {
   ...
   /** {@inheritDoc} **/
   @Override
   public long getBits(final Value value, final DebugContext context) throws ViewerException {
   ...
   /** {@inheritDoc} **/
   @Override
   public double getDoubleValue(final Value value, final DebugContext context) throws ViewerException {
   ...
   public void getInfo(final ViewerInfo vi) {
      ...
      vi.setLongDescription("This viewer displays a Double value, and the details of its binary representation.");
   }
   ...
   /** {@inheritDoc} **/
   @Override
   public String getValueText(final Value value, final DebugContext context) throws ViewerException {
    ...
    *
    * @throws ViewerException if an error occurs while retrieving the value. **/
   private static double getValue(final Value value, final DebugContext context) throws ViewerException {
      Method getValueMethod = value.getMethod(context, "doubleValue", "double", null);
      return value.invokeMethod(context, getValueMethod, null).toDouble(context);
   }
}
